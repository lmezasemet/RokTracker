...
class BasicOptionsFame(customtkinter.CTkFrame):
    def __init__(self, master, config):
        ...
        self.scan_amount_label = customtkinter.CTkLabel(
            self, text="How many people:", height=1
        )
...
class ScanOptionsFrame(customtkinter.CTkFrame):
    def __init__(self, master, values):
        ...
        self.fourth_screen_options_frame = CheckboxFrame(self, values, "Fourth Screen")
        ...
        self.fourth_screen_options_frame.grid(
            row=3, column=0, padx=10, pady=(0, 10), sticky="ewsn"
        )
    ...
    def get(self):
        ...
        options.update(self.fourth_screen_options_frame.get())
        return options
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Kingdom Scanner by Troystars")
        ...
        # Set up the last governor frame
    ...
    # Set the governor data with "kingdom" data
    def kingdom_callback(self, kingdom_data: Dict[str, str]):
        self.last_gov_frame.set(kingdom_data)
